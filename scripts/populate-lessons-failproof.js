    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          ...
          { id: genId(), type: "quiz", content: { question: "What is fitrah?", options: ["The soul after death", "Innate human nature inclined toward God", "The physical body"], correctIndex: 1 } },
    ...
    pages: [
      ...
      },
      {
        ...
        content: [
          ...
          { id: genId(), type: "text", content: "**Omar Suleiman – \"Why Did God Create Us?\"**\nExplains the purpose of creation, emphasizing that life is a test." }
        ]
      },
      {
        page_number: 3,
...
async function start() {
    ...
    // REMOVED .eq('status', 'published') to prevent Silent Null Crash
    const { data: courses } = await supabase.from('jobs').select('id, title');
