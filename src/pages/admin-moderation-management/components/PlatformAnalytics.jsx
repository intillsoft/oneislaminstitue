...
const PlatformAnalytics = ({ dateRange }) => {
  ...
  const loadAnalytics = async () => {
    try {
      ...
      const communityHealthMetrics = [
        ...
        {
          id: 2,
          title: 'Course Production Volume',
          value: filteredJobs.length.toLocaleString(),
          change: 0,
          changeType: 'increase',
          icon: 'Briefcase',
          color: 'secondary',
          description: 'Courses published this period'
        },
        {
          id: 3,
          ...
          icon: 'CheckCircle',
          color: 'accent',
          description: 'Confirmed enrollments'
        },
        {
          id: 4,
          ...
          icon: 'FileText',
          color: 'warning',
          description: 'Enrollments received'
        }
      ];
  ...
  return (
    <div className="space-y-8 relative">
      ...
      <div className="bg-white/[0.01] border border-white/5 rounded-3xl overflow-hidden mt-8">
        <div className="p-8">
      ...
      <div className="bg-white/[0.01] border border-white/5 rounded-3xl overflow-hidden">
        <div className="p-8">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8">
            <h3 className="text-sm font-bold text-white uppercase tracking-widest">Growth Trends</h3>
            ...
            <table className="min-w-full">
              <thead>
                <tr className="border-b border-border dark:border-gray-700">
                  ...
                  <th className="text-left py-3 px-4 sm:px-6 text-sm font-medium text-text-secondary dark:text-gray-400">Courses Published</th>
                  <th className="text-left py-3 px-4 sm:px-6 text-sm font-medium text-text-secondary dark:text-gray-400">Enrollments</th>
