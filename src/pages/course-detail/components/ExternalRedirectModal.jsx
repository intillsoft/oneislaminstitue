    ...
    return (
        <AnimatePresence>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
                ...
                >
                    {/* Header Accent */}
                    <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[var(--color-primary)] via-[var(--color-primary)] to-[var(--color-primary)]" />

                    {/* Close Button */}
                    <button
                        onClick={onClose}
                        className="absolute top-4 right-4 p-2 rounded-xl text-slate-400 hover:text-[var(--color-text-secondary)] dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5 transition-all z-10"
                    >
                        <X className="w-5 h-5" />
                    </button>
                    ...
                    <div className="p-8">
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex gap-4">
                                <div className="mt-1 w-8 h-8 rounded-lg bg-[var(--color-primary)]/10 flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <button
                                onClick={onConfirm}
                                className="flex-[1.5] px-6 py-4 rounded-xl bg-[var(--color-primary)] text-white font-black text-[10px] uppercase tracking-widest hover:scale-[1.02] shadow-lg shadow-emerald-900/10 flex items-center justify-center gap-2 group transition-all active:scale-[0.98]"
                            >
