...
const JoinTeam = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[var(--color-bg-dark)] selection:bg-[var(--color-primary)]/30">
            {/* Hero */}
            <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-24 px-4 overflow-hidden bg-white dark:bg-[#080d1a]">
                ...
                <div className="max-w-5xl mx-auto text-center relative z-10">
                    ...
                    >
                        <span className="inline-block px-3 sm:px-4 py-1 sm:py-1.5 rounded-full bg-[var(--color-primary-light)] dark:bg-[var(--color-primary)]/10 text-[var(--color-primary)] dark:text-[var(--color-primary)] text-[9px] sm:text-[10px] font-black uppercase tracking-widest mb-4 sm:mb-6 border border-[var(--color-border-secondary)] dark:border-[var(--color-primary)]/20">
                            Research & Curation
                        </span>
                        <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-[var(--color-text-primary)] dark:text-white mb-4 sm:mb-6 tracking-tight leading-[1.2] sm:leading-[1.1]">
                            Build the Ultimate <br className="hidden sm:block" />
                            <span className="text-[var(--color-primary)] dark:text-[var(--color-primary)]">Learning Platform</span>
                        </h1>
                        <p className="text-sm sm:text-base md:text-xl text-[var(--color-text-secondary)] dark:text-slate-400 mb-8 sm:mb-10 max-w-2xl mx-auto leading-relaxed px-2">
                        ...
                        <div className="flex justify-center sm:flex-row flex-col gap-3 px-4 sm:px-0">
                            <button 
                                ...
                                className="w-full sm:w-auto px-6 sm:px-8 py-3.5 sm:py-4 bg-slate-900 dark:bg-white text-white dark:text-[var(--color-text-primary)] rounded-xl sm:rounded-2xl font-black transition-all shadow-xl active:scale-[0.98] flex items-center justify-center gap-2 uppercase tracking-widest text-[10px] sm:text-xs"
                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {benefits.map((item, idx) => (
                            <motion.div
                                ...
                                className="p-8 rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:border-[var(--color-primary)]/50 transition-colors group"
                            >
                                <div className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-800 shadow-sm flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                    <item.icon className="w-7 h-7 text-[var(--color-primary)] dark:text-[var(--color-primary)]" />
                                </div>
                                <h3 className="text-xl font-bold text-[var(--color-text-primary)] dark:text-white mb-3">{item.title}</h3>
                                <p className="text-[var(--color-text-tertiary)] dark:text-slate-400 leading-relaxed text-sm">
                                    {item.desc}
                                </p>
                            </motion.div>
                        ))}
            ...
            {/* Application Steps */}
            <section className="py-24 bg-white dark:bg-slate-900/50 border-y border-[var(--color-border-primary)] dark:border-slate-800">
                <div className="max-w-4xl mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-bold text-[var(--color-text-primary)] dark:text-white mb-4">Application Process</h2>
                        <p className="text-[var(--color-text-tertiary)] dark:text-slate-400">Our vetting process ensures the highest standard of instruction.</p>
                    </div>
                    ...
                    <div className="space-y-12 relative">
                        ...
                        {[
                            ...
                            <div key={idx} className="relative z-10 flex gap-6">
                                <div className="w-14 h-14 rounded-full bg-white dark:bg-slate-900 border-4 border-slate-50 dark:border-black flex items-center justify-center font-black text-xl text-[var(--color-primary)] shadow-sm flex-shrink-0">
                                    {item.step}
                                </div>
                                <div className="pt-2">
                                    <h3 className="text-xl font-bold text-[var(--color-text-primary)] dark:text-white mb-2">{item.title}</h3>
                                    <p className="text-[var(--color-text-secondary)] dark:text-slate-400 max-w-lg">{item.desc}</p>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="py-24 px-4">
                <div className="max-w-5xl mx-auto bg-slate-900 rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden">
                    <div className="relative z-10">
                        ...
                        <button 
                            onClick={scrollToForm}
                            className="mt-12 px-10 py-4 bg-[var(--color-primary)] hover:bg-[var(--color-primary)] text-white rounded-xl font-bold transition-all shadow-lg shadow-[var(--color-primary)]/20"
                        >
                            Apply Now
                        </button>
                    </div>
                ...
                <div className="max-w-4xl mx-auto">
                    {isSubmitted ? (
                        <motion.div 
                            ...
                            className="bg-slate-900 border border-[var(--color-primary)]/30 p-10 rounded-[3rem] text-center shadow-2xl"
                        >
                        ...
                        >
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input 
                                                ...
                                                className="w-full bg-slate-800 border border-slate-700 rounded-2xl py-4 pl-14 pr-6 focus:border-[var(--color-primary)] outline-none transition-all font-bold placeholder:text-[var(--color-text-secondary)] text-white"
                                            />
                                        </div>
                                    </div>
                                    <div className="space-y-2">
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-black uppercase tracking-[0.2em] text-[var(--color-text-tertiary)] ml-4">Area of Expertise / Role</label>
                                    <div className="relative">
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                        {['Academic', 'Engineer', 'Designer', 'Creative'].map((type) => (
                                            <button
                                                ...
                                                className={`py-3 rounded-xl font-bold text-xs uppercase tracking-widest border transition-all ${formData.experience === type.toLowerCase() ? 'bg-[var(--color-primary)] border-[var(--color-primary)] text-white' : 'bg-slate-800 border-slate-700 text-slate-400 hover:border-[var(--color-primary)]/50'}`}
                                            >
                                                {type}
                                            </button>
                                        ))}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <textarea 
                                            ...
                                            className="w-full bg-slate-800 border border-slate-700 rounded-2xl py-4 pl-14 pr-6 focus:border-[var(--color-primary)] outline-none transition-all font-bold placeholder:text-[var(--color-text-secondary)] text-white resize-none"
                                        />
                                    </div>
                                </div>
