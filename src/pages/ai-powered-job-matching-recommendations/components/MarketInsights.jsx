  ...
  return (
    <div className="space-y-8">
      <div className="flex items-baseline justify-between mb-2">
        <h3 className="text-xl font-black text-[var(--color-text-primary)] dark:text-white uppercase tracking-tighter">Market Intelligence</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {insights.map((stat, i) => (
          <div key={i} className="glass-panel p-6 rounded-3xl border border-[var(--color-border-primary)] dark:border-white/5 bg-white/50 dark:bg-white/5 backdrop-blur-xl group hover:shadow-2xl transition-all">
            ...
            <div>
              ...
              <div className="flex items-baseline gap-2 mb-1">
                <span className="text-2xl font-black text-[var(--color-text-primary)] dark:text-white tracking-tighter">{stat.value}</span>
                <span className={`text-[10px] font-bold ${stat.color}`}>{stat.trend}</span>
              </div>
              <p className="text-[10px] font-medium text-[var(--color-text-tertiary)] dark:text-[var(--color-text-tertiary)]">{stat.subtitle}</p>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-12">
        {/* Top Firms Section */}
        <div className="glass-panel p-8 rounded-[2.5rem] border border-[var(--color-border-primary)] dark:border-white/5 bg-white/50 dark:bg-white/5 backdrop-blur-xl">
          ...
          <div className="space-y-4">
            {topCompaniesHiring.map((company, i) => (
              <div key={i} className="flex items-center justify-between group cursor-pointer p-2 hover:bg-white dark:hover:bg-white/5 rounded-2xl transition-colors">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="text-sm font-black text-[var(--color-text-primary)] dark:text-white tracking-tight">{company.name}</span>
        ...
        <div className="glass-panel p-8 rounded-[2.5rem] border border-[var(--color-border-primary)] dark:border-white/5 bg-white/50 dark:bg-white/5 backdrop-blur-xl flex flex-col items-center justify-center text-center relative overflow-hidden group">
          ...
          <h4 className="text-lg font-black text-[var(--color-text-primary)] dark:text-white mb-2 uppercase tracking-tighter">Market Penetration Analytics</h4>
          <p className="text-xs text-[var(--color-text-tertiary)] dark:text-slate-400 max-w-xs mb-6">
          ...
          <div className="flex gap-4">
            ...
            <div className="text-center">
              <div className="text-xl font-black text-[var(--color-primary)]">14ms</div>
          ...
          <div>
            ...
            {loading ? (
              ...
              <>
                ...
                <button className="h-12 px-8 rounded-xl bg-white text-[var(--color-text-primary)] font-black text-xs uppercase tracking-widest hover:bg-workflow-primary hover:text-white transition-all flex items-center gap-2">
