          ...
          {!activeMode && (
            ...
            >
              ...
              <motion.button
                ...
                className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-[var(--color-primary)] text-white flex items-center justify-center shadow-lg shadow-[var(--color-primary)]/30 border border-white/10 group relative"
              >
              ...
              <motion.button
                ...
                className="w-14 h-14 rounded-full bg-gradient-to-br from-[var(--color-primary)] to-blue-600 text-white flex items-center justify-center shadow-lg shadow-[var(--color-primary)]/30 border border-white/10 group relative"
              >
                <div className="absolute inset-0 rounded-full bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity" />
