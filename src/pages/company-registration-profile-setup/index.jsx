...
const CompanyRegistrationProfileSetup = () => {
  ...
  useEffect(() => {
    // Only save draft when form is touched AND not on preview step
    if (formTouched && currentStep !== 5) {
  ...
  }, [formData, formTouched, currentStep]);
  ...
  const handleChange = (e) => {
    ...
    setFormData(prevData => {
      ...
      // Save to localStorage immediately (except on preview step)
      if (currentStep !== 5) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let logoUrl = formData.logoPreview || null;
      ...
      const companyData = {
        ...
        founded_year: formData.foundingYear ? parseInt(formData.foundingYear) : null,
      };
      ...
      showError('Failed to create company profile. Please try again.');
    } finally {
  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-[#0A0E27] pb-16 overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-text-primary dark:text-white mb-2">Company Registration & Profile Setup</h1>
          <p className="text-text-secondary dark:text-gray-400 max-w-3xl">
        ...
        <div className="bg-surface-100 dark:bg-surface-800 rounded-lg p-6 border border-border dark:border-gray-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="#" className="flex items-center text-primary hover:text-primary-700 dark:hover:text-primary-400 transition-smooth">
