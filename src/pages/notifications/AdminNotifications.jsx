    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden flex flex-col">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl">
          <div className="absolute top-[-5%] right-[-10%] w-[50%] h-[50%] bg-[var(--color-primary)]/5 rounded-full blur-[160px]" />
                        ...
                        <div className="relative z-10 grid lg:grid-cols-3 gap-16">
                            ...
                            <div className="space-y-12">
                                <div className="space-y-6">
                                    <label className="text-[10px] font-bold uppercase tracking-widest text-[var(--color-text-tertiary)] ml-1">Send to</label>
                            ...
                            <div className="lg:col-span-2 space-y-12">
                                <div className="flex items-center justify-between border-b border-border/40 pb-4">
                                    <div className="flex gap-6">
                                        <button 
                                            ...
                                            className={`text-[10px] font-bold uppercase tracking-widest transition-all ${composeMode === 'simple' ? 'text-[var(--color-primary)]' : 'text-[var(--color-text-secondary)]'}`}
                                        >
                                            Simple Mode
                                        </button>
                                        <button 
                                            onClick={() => setComposeMode('advanced')}
                                            className={`text-[10px] font-bold uppercase tracking-widest transition-all ${composeMode === 'advanced' ? 'text-[var(--color-primary)]' : 'text-[var(--color-text-secondary)]'}`}
                                        >
                                            Advanced Mode
                                        </button>
                                    </div>
                                ...
                                {composeMode === 'simple' ? (
                                    <div className="space-y-12 animate-in fade-in duration-500">
                                        <div className="space-y-6">
                                            <label className="text-[10px] font-bold uppercase tracking-widest text-[var(--color-text-tertiary)] ml-1">Universal Subject</label>
                                            <input
                                                type="text"
                                        ...
                                        <div className="space-y-6">
                                            <label className="text-[10px] font-bold uppercase tracking-widest text-[var(--color-text-tertiary)] ml-1">Universal Message</label>
                                            <textarea
                                    ...
                                    <div className="space-y-12 animate-in slide-in-from-right-2 duration-500">
                                        {/* In-App / Default */}
                                        <div className="space-y-6">
                                            <label className="text-[10px] font-bold uppercase tracking-widest text-[var(--color-primary)] ml-1">In-App Alert (Primary)</label>
                                            <input
                                                type="text"
                                                value={composeData.title}
                                                onChange={(e) => setComposeData({ ...composeData, title: e.target.value })}
                                ...
                                <div className="flex pt-6">
                                    <button
                                        ...
                                        disabled={loading}
                                        className="w-full bg-[var(--color-primary)] text-white py-5 rounded-xl text-[11px] font-bold uppercase tracking-widest hover:bg-[var(--color-primary)] transition-all disabled:opacity-30 flex items-center justify-center gap-4"
                                    >
                                        {loading ? (
                ...
                <div className="flex gap-8 sm:gap-12">
                  {[
                    ...
                    >
                      {t.label}
                      {filter === t.id && (
                        <motion.div layoutId="admin-tab" className="absolute bottom-[-1px] left-0 right-0 h-0.5 bg-[var(--color-primary)]" />
                      )}
                    </button>
                  ))}
                </div>
              ...
              <div className="bg-card/45 border border-border/40 rounded-2xl p-6 lg:p-10 backdrop-blur-3xl relative">
                <div className="max-w-4xl mx-auto space-y-10">
                  ...
                  <div className="pt-6 border-t border-border/40 grid sm:grid-cols-2 gap-8 text-[10px] font-bold uppercase tracking-widest">
                    ...
                    <div>
                      <p className="text-[var(--color-text-secondary)] mb-2">Recipient Category</p>
                      <p className="text-[var(--color-primary)]">{selectedNotification.data?.recipient_type || 'General'}</p>
                    </div>
                  </div>
