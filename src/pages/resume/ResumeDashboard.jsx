            ...
            <div className="max-w-[1600px] mx-auto px-6 lg:px-16 pt-12">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
                    ...
                    >
                        ...
                        <p className="text-[var(--color-text-tertiary)] font-bold uppercase tracking-[0.2em] text-[10px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
                    ...
                    <div className="glass-panel p-8 rounded-[2rem] flex flex-col justify-between overflow-hidden relative group cursor-pointer border-workflow-primary/20 bg-workflow-primary/5">
                        ...
                        <ArrowRight className="relative z-10 w-6 h-6 text-[var(--color-text-tertiary)] group-hover:translate-x-2 transition-transform" />
                    </div>
                </div>
                ...
                <div className="space-y-8">
                    <div className="flex items-center justify-between border-b border-white/5 pb-4">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="font-black uppercase tracking-[0.2em] text-[10px] text-[var(--color-text-tertiary)]">Document Vault</h2>
                        </div>
                        <div className="flex items-center gap-6">
                            <div className="flex bg-white/[0.03] p-1 rounded-xl border border-white/5">
                                ...
                                <button className="p-2 text-[var(--color-text-tertiary)]"><ListIcon size={16} /></button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                            ...
                            >
                                ...
                                <div className="text-center">
                                    <span className="block text-sm font-black text-[var(--color-text-tertiary)] uppercase tracking-widest group-hover:text-workflow-primary transition-colors">New Resume</span>
                            ...
                            {filteredResumes.map((resume, idx) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        whileHover={{ y: -8 }}
                                        className="group relative aspect-[3/4] bg-white dark:bg-[#0F172A] rounded-2xl border border-[var(--color-border-primary)] dark:border-white/5 transition-all overflow-hidden flex flex-col shadow-lg hover:shadow-2xl hover:border-workflow-primary/30"
                                    >
                                        {/* THUMBNAIL AREA */}
                                        {/* AVATAR THUMBNAIL AREA */}
                                        <div
                                            className="relative h-[60%] cursor-pointer bg-white dark:bg-[#0B1121] flex items-center justify-center overflow-hidden"
                                        ...
                                        >
                                            ...
                                            <div className="absolute inset-0 bg-slate-900/40 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center z-20">
                                                <div className="scale-90 group-hover:scale-100 transition-transform duration-500">
                                                    <button className="h-10 px-6 rounded-xl bg-white text-[var(--color-text-primary)] text-[10px] font-black uppercase tracking-widest shadow-xl hover:scale-105 transition-transform">
                                                        Open Editor
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            {resume.ats_score && (
                                                <div className="absolute top-4 right-4 z-20">
                                                    <div className="bg-white/90 dark:bg-black/40 backdrop-blur-md px-3 py-1.5 rounded-xl shadow-lg flex items-center gap-2 border border-white/20">
                                                        ...
                                                        <span className="text-[10px] font-black text-[var(--color-text-primary)] dark:text-white uppercase tracking-tighter">{resume.ats_score} ATS</span>
                                                    </div>
                                                </div>
                                            )}
                                        </div>
                                        ...
                                        <div className="flex-1 p-6 flex flex-col justify-between bg-white dark:bg-[#0F172A] relative">
                                            <div>
                                                <h3 className="text-lg font-bold text-[var(--color-text-primary)] dark:text-white leading-snug mb-1 truncate group-hover:text-workflow-primary transition-colors">
                ...
                <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={() => setExportResume(null)}>
                    ...
                    >
                        <div className="flex justify-between items-center mb-8">
                            <h2 className="text-2xl font-black uppercase tracking-tight text-[var(--color-text-primary)] dark:text-white">Export Asset</h2>
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            >
                                <div className="w-12 h-12 rounded-xl bg-white dark:bg-white/5 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                                    <LayoutGrid className="text-[var(--color-text-tertiary)] group-hover:text-workflow-primary" />
                                </div>
                                <div>
                                    <h3 className="font-bold text-[var(--color-text-primary)] dark:text-white">JSON Data</h3>
                                    <p className="text-xs text-[var(--color-text-tertiary)] font-medium">Raw structured data</p>
                                </div>
                            ...
                            >
                                <div className="w-12 h-12 rounded-xl bg-white dark:bg-white/5 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                                    <FileText className="text-[var(--color-text-tertiary)] group-hover:text-workflow-primary" />
                                </div>
                                <div>
                                    <h3 className="font-bold text-[var(--color-text-primary)] dark:text-white">PDF Document</h3>
                                    <p className="text-xs text-[var(--color-text-tertiary)] font-medium">Open Editor to Print/Export</p>
                                </div>
                                <ArrowRight className="ml-auto text-slate-300 group-hover:text-workflow-primary group-hover:translate-x-1 transition-all" />
                            </button>
                        </div>
                ...
                <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={() => setDeleteResume(null)}>
                    ...
                    >
                        <div className="flex flex-col items-center text-center gap-4">
                            ...
                            <h2 className="text-xl font-black uppercase tracking-tight text-[var(--color-text-primary)] dark:text-white">Delete Document?</h2>
                            <p className="text-sm text-[var(--color-text-tertiary)] font-medium">
                                You are about to permanently destroy <span className="text-[var(--color-text-primary)] dark:text-white font-bold">"{deleteResume.title}"</span>. This action cannot be undone.
                            </p>

                            <div className="grid grid-cols-2 gap-4 w-full mt-6">
                                <button
                                    onClick={() => setDeleteResume(null)}
                                    className="py-3 rounded-xl bg-slate-100 dark:bg-white/5 text-[var(--color-text-secondary)] dark:text-slate-300 text-xs font-black uppercase tracking-widest hover:bg-slate-200 dark:hover:bg-white/10 transition-colors"
                                >
                                    Cancel
                                </button>
                                <button
...
const StatCard = ({ label, value, icon: Icon, sub }) => (
    ...
    >
        <div className="flex justify-between items-start">
            ...
            <span className="text-[9px] font-black text-[var(--color-text-secondary)] uppercase tracking-[0.2em]">{label}</span>
        </div>
        <div>
            <div className="text-4xl font-[1000] text-white tracking-tighter mb-1">{value}</div>
            <div className="text-[10px] font-bold text-[var(--color-text-tertiary)] uppercase tracking-tighter">{sub}</div>
        </div>
    </motion.div>
);
