...
const RecommendedCourseCard = ({ course, index }) => {
  ...
  return (
    ...
    >
      {/* Card shell */}
      <div className="relative rounded-xl overflow-hidden bg-white dark:bg-[#0d1025] border border-slate-200 dark:border-white/[0.08] shadow-sm hover:shadow-md transition-all duration-300 flex flex-col h-full">
