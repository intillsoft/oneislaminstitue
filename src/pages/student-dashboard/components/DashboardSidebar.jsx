...
const DashboardSidebar = ({ activeTab, setActiveTab, userData }) => {
  ...
  const quickActions = [
    { id: 'profile', label: 'Edit Profile', icon: 'User', path: '/user-profile' },
    { id: 'resume', label: 'Update Resume', icon: 'FileUp', path: '/resume-builder-ai-enhancement' },
    { id: 'settings', label: 'Settings', icon: 'Settings', path: '/user-profile?tab=settings' },
