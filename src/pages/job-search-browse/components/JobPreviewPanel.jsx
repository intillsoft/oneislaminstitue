...
const JobPreviewPanel = ({ job, onClose, isSaved, onSave }) => {
  ...
  return (
    <div className="bg-background dark:bg-[#13182E] border border-border dark:border-gray-700 rounded-lg shadow-soft h-fit sticky top-6 overflow-x-hidden">
      {/* Header */}
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-text-primary dark:text-white mb-1">{job?.title}</h3>
      ...
      <div className="p-6 space-y-6">
        {/* Description */}
        <div>
          <h4 className="text-sm font-semibold text-text-primary dark:text-white mb-3">Job Description</h4>
          <div className="text-sm text-text-secondary dark:text-gray-400 space-y-2">
            {job?.description ? (
        ...
        {/* Requirements */}
        <div>
          <h4 className="text-sm font-semibold text-text-primary dark:text-white mb-3">Requirements</h4>
        ...
        {/* Company Info */}
        <div>
          <h4 className="text-sm font-semibold text-text-primary dark:text-white mb-3">Company Info</h4>
          <div className="space-y-2 text-sm text-text-secondary dark:text-gray-400">
            <div className="flex items-center space-x-2">
