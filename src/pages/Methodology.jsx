    ...
    return (
        <div className="min-h-screen bg-[#0A1120] text-white selection:bg-[var(--color-primary)]/30 overflow-x-hidden safe-area-inset">
            ...
            <section className="relative pt-16 sm:pt-24 md:pt-32 pb-12 sm:pb-16 px-3 sm:px-4 md:px-6 overflow-hidden">
                ...
                <div className="absolute top-4 sm:top-10 left-1/2 -translate-x-1/2 w-72 sm:w-96 md:w-[600px] h-72 sm:h-96 md:h-[600px] bg-[var(--color-primary)]/15 rounded-full blur-[90px] sm:blur-[110px] md:blur-[128px] pointer-events-none" />
                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    >
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black mb-2 sm:mb-3 tracking-tight leading-tight uppercase font-display">
                            ...
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-primary)] via-cyan-400 to-emerald-300">Build Curricula</span>
                        </h1>
            ...
            <section className="py-16 sm:py-20 px-4 relative overflow-hidden">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <div className="h-1.5 w-24 bg-[var(--color-primary)] mx-auto rounded-full" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {processSteps.map((step, idx) => (
                            <motion.div
                                ...
                                className="p-8 rounded-3xl bg-slate-900/50 border border-slate-800 hover:border-[var(--color-primary)]/30 transition-all group"
                            >
                                <div className="w-14 h-14 rounded-2xl bg-[var(--color-primary)]/10 flex items-center justify-center mb-4 border border-[var(--color-primary)]/20 group-hover:scale-110 transition-transform">
            ...
            <section className="py-16 sm:py-20 bg-slate-900/50 border-y border-slate-800/50 relative">
                ...
                <div className="max-w-5xl mx-auto px-4 relative z-10 text-center">
                    <h3 className="text-xs font-black text-[var(--color-primary)] uppercase tracking-[0.3em] mb-8">Authorized Base Sources</h3>
                    <div className="flex flex-wrap justify-center gap-4">
                        {sources.map((source, idx) => (
                            <div key={idx} className="px-6 py-3 rounded-xl bg-slate-800 border border-slate-700 font-bold text-slate-300 hover:text-white hover:border-[var(--color-primary)] transition-all cursor-default">
                                {source}
                            </div>
                        ))}
                    </div>
                    <p className="mt-6 text-[var(--color-text-tertiary)] text-xs max-w-2xl mx-auto italic">
            ...
            <section className="py-16 sm:py-20 px-4 text-center">
                <div className="max-w-4xl mx-auto">
                    ...
                    <button 
                        ...
                        className="px-10 py-5 bg-[var(--color-primary)] hover:bg-[var(--color-primary)] text-white rounded-2xl font-black uppercase tracking-widest text-sm transition-all shadow-xl shadow-[var(--color-primary)]/20 flex items-center justify-center gap-3 mx-auto"
                    >
