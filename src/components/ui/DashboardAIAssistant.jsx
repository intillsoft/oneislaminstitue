...
const DashboardAIAssistant = ({
  ...
  const dashboardConfigs = {
    admin: {
      ...
      quickPrompts: [
        'Analyze academy performance',
        'Suggest student moderation improvements',
    ...
    recruiter: {
      ...
      quickPrompts: [
        'Analyze student roster',
        'Suggest course improvements',
        'Review enrollment trends',
        'Optimize curriculum strategy'
      ],
      systemMessage: 'You are workflowAI, an intelligent assistant for instructors. Help with student management, course material optimization, academic strategies, and enrollment analytics.'
    },
    'job-seeker': {
      name: 'Student AI Assistant',
      icon: <Users className="w-5 h-5" />,
      quickPrompts: [
        'Improve my course success rate',
        'Analyze my academic progress',
        'Suggest subjects to study',
        'Optimize my student profile'
      ],
      systemMessage: 'You are workflowAI, an intelligent assistant for students. Help with learning strategies, enrollment optimization, skill development, and academic guidance.'
    },
    talent: {
      ...
      systemMessage: 'You are workflowAI, an intelligent assistant for specialized scholars. Help with seminar optimization, academic strategies, scholar management, and profile improvement.'
    }
  };
              ...
              <div className="flex items-center justify-between p-6 border-b border-[#E2E8F0] dark:border-[#1E2640]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-text-secondary dark:text-[#8B92A3]">Powered by workflowAI</p>
                  </div>
                </div>
                <button
