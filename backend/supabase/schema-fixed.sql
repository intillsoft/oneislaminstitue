-- FIXED Database Schema for Workflow Platform
-- This version fixes the auth.role() error by using auth.uid() IS NOT NULL instead
...
-- Jobs policies - FIXED: Use auth.uid() IS NOT NULL instead of auth.role()
