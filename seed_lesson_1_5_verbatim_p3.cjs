...
async function run() {
    ...
    if (!page3) {
         console.log('NO PAGE 3 FOUND');
         return;
    }

    // Explicitly rebuild Page 3 to be 100% Verbatim flawless Coordinate
    page3.content = [
           {
              "id": "intro_text",
              "type": "text",
    ...
    if (error) {
         console.error('ERROR SEEDING P3 VERBATIM:', error);
         return;
    }

    console.log('PAGE 3 VERBATIM RESTORE OK');
}
